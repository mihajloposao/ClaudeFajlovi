...
> **Registar svega sto jos nije odluceno.** Ovo je najvazniji fajl u ranoj fazi.
>
> Pravilo: cim se pojavi pretpostavka koju Mihajlo nije izricito potvrdio, ona ide OVDE —
> ne u `svet.md`, ne u `zaplet.md`, ne kao gotova cinjenica u razgovoru.
> Nista se ne proglasava zakonom price dok Mihajlo to ne kaze.
>
> Vracamo se ovde redovno: da vidimo sta je u medjuvremenu dobilo odgovor,
> sta je postalo nebitno, i da li se prica negde sama sa sobom posvadjala.
>
> Kada pitanje dobije odgovor: prebacuje se u `dnevnik-odluka.md` sa obrazlozenjem,
> i brise odavde.

---

## KRITICNO — blokira sve ostalo
...
| # | Pitanje | Status | Napomena |
|---|---|---|---|
| S1 | Odakle zveri i sta su zapravo? | otvoreno | Radna pretpostavka: bio-oruzje pusteno u ratu. Nije potvrdjeno. |
| S2 | Da li iko ima kontrolu nad zverima? | otvoreno | Radna pretpostavka: niko na terenu. Ne znaci da niko nigde. |
| S3 | Postoji li sila koja moze pomoci — vojna, naucna, ili neka druga? | otvoreno | Mihajlo izricito ostavio kao mogucnost. Menjala bi zanr i ulog. |
| S4 | Moze li se rat dobiti? Postoji li nesto sto se moze pobediti? | otvoreno | Ranije prerano zatvoreno sa "ne". Povuceno. |
| S5 | Koliki je obuhvat — jedan grad, zemlja, ceo svet? | otvoreno | |
| S6 | Zasto vojska odvodi radno sposobne? Za sta? | otvoreno | Daje prici odrediste ako se odgovori konkretno. |
| S7 | Ko je "neprijatelj" u geopolitickom smislu i da li ga ikad vidimo? | otvoreno | |
| S8 | Koliko traje radnja knjige — dani, meseci, godine? | otvoreno | |

## Likovi i grupa

| # | Pitanje | Status | Napomena |
|---|---|---|---|
| L1 | Troje ili cetvoro? | suzeno | Mihajlo: "troje ili cetvoro". Finalno se zakljucava kad se definisu. |
| L2 | Ko su oni — imena, godine, sta ih spaja, sta ih je vec delilo pre te veceri? | otvoreno | |
| L3 | Sta su igrali te veceri? | otvoreno | Predlog: neka bude konkretno i imenovano, sa mogucnoscu povratka kasnije. |
| L4 | Ko od njih umire, ako iko? Sa razlogom ili besmisleno? | otvoreno | Vezano za K1 i K2. |
| L5 | Ko preuzima odlucivanje u grupi i po kom pravu? | otvoreno | |

## Forma

| # | Pitanje | Status | Napomena |
|---|---|---|---|
| F1 | Lice i glagolsko vreme? Koliko POV likova? | otvoreno | |
| F2 | Samostalna knjiga ili prvi deo serijala? | otvoreno | Mihajlo pomenuo mogucnost sledeceg dela. Utice na to koliko se zatvara na kraju. |
| F3 | Latinica ili cirilica? | otvoreno | |
